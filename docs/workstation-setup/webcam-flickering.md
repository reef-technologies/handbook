...
if your web camera is blinking on video calls:
<https://apps.microsoft.com/store/detail/windows-camera/9WZDNCRFJBBG>
...
You'd think in 2023 a modern operating system, driver, video chat software *or something* should detect camera flickering and set the filter appropriately, but no :)
