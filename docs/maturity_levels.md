We've observed that usually the projects we work on can be classified into one of five maturity (quality?) levels. We list them below so that they can be referred to if needed.
