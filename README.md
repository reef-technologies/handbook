...
| RTO / status call                        | Weekly status calls. Please toggle between this and client-specific project during duration of the call dedicated to status of the project you are explicitly assigned to.                                                                              |
