...
Why is this list here, you may ask - don't all RT developers follow all of those subconsciously? Usually yes, but some of our trial candidates said it would be easier for them if they could look at the list, so we wrote it down out of respect for them.
...
If you find that some key knowledge (not covered by the NDA) that might be useful for the next candidate is missing from this document, please create a pull request. Log the time spend on this to `RT / other internal development`.
